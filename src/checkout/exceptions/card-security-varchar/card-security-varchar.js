...
export async function exceptionCheckoutCardSecurityVarchar(driver) {
    try {
        ...
        await driver.findElement(By.name("verification_value")).sendKeys("abc");
        await driver.sleep(2000);
        await driver.switchTo().defaultContent();
        ...
        console.log("Checkout card security varchar successfully");
        await driver.sleep(2000);
    }
}
