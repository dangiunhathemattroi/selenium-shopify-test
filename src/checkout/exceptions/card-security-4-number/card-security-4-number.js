...
export async function exceptionCheckoutCardSecurity4Number(driver) {
    try {
        ...
        await driver.findElement(By.name("verification_value")).sendKeys("1234");
        await driver.sleep(2000);
        await driver.switchTo().defaultContent();
        ...
        console.log("Checkout card security 4 number successfully");
        await driver.sleep(2000);
    }
}
