...
export async function exceptionCheckoutCardExpFormatFail(driver) {
    try {
        ...
        await driver.findElement(By.name("expiry")).sendKeys("32");
        await driver.sleep(2000);
        await driver.switchTo().defaultContent();
        ...
        console.log("Checkout Exp format successfully");
        await driver.sleep(2000);
    }
}
