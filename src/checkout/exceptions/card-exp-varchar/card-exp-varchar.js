...
export async function exceptionCheckoutCardExpVarchar(driver) {
    try {
        ...
        await driver.findElement(By.name("expiry")).sendKeys("ab");
        await driver.sleep(2000);
        await driver.switchTo().defaultContent();
        ...
        console.log("Checkout exp varchar successfully");
        await driver.sleep(2000);
    }
}
