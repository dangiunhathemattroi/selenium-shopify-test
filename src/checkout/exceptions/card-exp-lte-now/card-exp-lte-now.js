...
export async function exceptionCheckoutCardExpLteNow(driver) {
    try {
        ...
        await driver.switchTo().frame(expiryFrame);
        await driver.findElement(By.name("expiry")).sendKeys("24");
        await driver.sleep(2000);
        await driver.switchTo().defaultContent();
        ...
        console.log("Checkout exp lte successfully");
        await driver.sleep(2000);
    }
}
